/**
 * CaseTimelineScrubber.tsx — scrub or play back the money trail through time.
 *
...
import type { ClusterEdge } from "../clusters/types";
...
export function CaseTimelineScrubber({ edges, value, onChange, durationMs = 8000 }: Props) {
