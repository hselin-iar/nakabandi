...
class AlertRepo(Protocol):
    ...
    def list_escalation_due_ids(self, cutoff: Any, limit: int) -> list[str]: ...

    def list_expiry_due_ids(self, now: Any, limit: int) -> list[str]: ...

    def list_miss_due_ids(self, cutoff: Any, limit: int) -> list[str]: ...

    def list_queue_entries(self, district_id: str | None, start: Any, end: Any) -> list[Any]: ...

    def save_budget(self, alert: Any) -> None: ...
